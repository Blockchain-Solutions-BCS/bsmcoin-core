...
#ifndef BSMCOIN_QT_SPLASHSCREEN_H
#define BSMCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. BsmCoin Core initialization
...
#endif // BSMCOIN_QT_SPLASHSCREEN_H
