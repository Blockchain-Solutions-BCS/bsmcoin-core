...
void CommunityFundDisplayPaymentRequestDetailed::setPrequestLabels() const
{
    ...
    // Link
    ui->labelPrequestLink->setText(QString::fromStdString("https://www.bsmexplorer.com/dao/payment-request/" + prequest.hash.ToString()));
    ...
    //set hyperlink for bsmcommunity proposal view
