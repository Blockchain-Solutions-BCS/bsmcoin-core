...
#ifndef BSMCOIN_QT_BSMCOINGUI_H
#define BSMCOIN_QT_BSMCOINGUI_H
...
/**
  BsmCoin GUI main class. This class represents the main window of the BsmCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BsmCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BsmCoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~BsmCoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bsmcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
