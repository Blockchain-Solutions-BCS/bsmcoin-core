...
#ifndef BSMCOIN_QT_WALLETFRAME_H
#define BSMCOIN_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, BsmCoinGUI *_gui = 0);
    ~WalletFrame();
...
#endif // BSMCOIN_QT_WALLETFRAME_H
