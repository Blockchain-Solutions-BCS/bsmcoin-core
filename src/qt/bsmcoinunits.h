...
#ifndef BSMCOIN_QT_BSMCOINUNITS_H
#define BSMCOIN_QT_BSMCOINUNITS_H
...
/** BsmCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BsmCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BsmCoinUnits(QObject *parent);

    /** BsmCoin units.
      @note Source: https://en.bsmcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        // Base currencies
...
typedef BsmCoinUnits::Unit BsmCoinUnit;

#endif // BSMCOIN_QT_BSMCOINUNITS_H
