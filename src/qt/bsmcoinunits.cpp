...
BsmCoinUnits::BsmCoinUnits(QObject *parent):
    QAbstractListModel(parent),
    unitlist(availableUnits())
{
}

QList<BsmCoinUnits::Unit> BsmCoinUnits::availableUnits()
{
    QList<BsmCoinUnits::Unit> unitlist;

    unitlist.append(BSM); // Bsmcoin
...
bool BsmCoinUnits::valid(int unit)
{
    switch(unit)
    {
        case BSM:
...
QString BsmCoinUnits::name(int unit)
{
    switch(unit)
    {
        case BSM: return QString("BSM");
...
QString BsmCoinUnits::description(int unit)
{
    switch(unit)
    {
        case BSM: return QString("Bsmcoin");
...
qint64 BsmCoinUnits::factor(int unit)
{
...
int BsmCoinUnits::decimals(int unit)
{
    switch(unit)
    {
        case BSM: return 8;
...
QString BsmCoinUnits::format(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators, bool fPretty)
{
...
QString BsmCoinUnits::pretty(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators)
{
...
// appropriate.
QString BsmCoinUnits::formatWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
    return QString("%1 %2").arg(format(unit, amount, plussign, separators), name(unit));
}

QString BsmCoinUnits::prettyWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
    return QString("%1 %2").arg(pretty(unit, amount, plussign, separators), name(unit));
}

QString BsmCoinUnits::formatHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool removeTrailing)
{
...
bool BsmCoinUnits::parse(int unit, const QString &value, CAmount *val_out)
{
...
QString BsmCoinUnits::getAmountColumnTitle(int unit)
{
    QString amountTitle = QObject::tr("Amount");
    if (BsmCoinUnits::valid(unit))
    {
        amountTitle += " ("+BsmCoinUnits::name(unit) + ")";
    }
    return amountTitle;
}

int BsmCoinUnits::rowCount(const QModelIndex &parent) const
{
    Q_UNUSED(parent);
    return unitlist.size();
}

QVariant BsmCoinUnits::data(const QModelIndex &index, int role) const
{
    int row = index.row();
