...
public:
    CMainParams()
    {
        ...
        consensus.nStakeMinAge = 10;   // minimum for coin age: 10 secq
        consensus.nTargetSpacing = 10; // Blocktime: 30 sec => 10 sec
        ...
        consensus.nTargetTimespan = 25 * 10;
      ...
      // Deployment of Cold Staking Pool Fee
        ...
        base58Prefixes[COLDSTAKING_ADDRESS_V2] = std::vector<unsigned char>(1,63);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,0);
        base58Prefixes[RAW_SCRIPT_ADDRESS] = std::vector<unsigned char>(1,3);
