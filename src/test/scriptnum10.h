...
#ifndef BSMCOIN_TEST_SCRIPTNUM10_H
#define BSMCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BsmCoin Core 0.10.0, for cross-comparison.
 */
public:
