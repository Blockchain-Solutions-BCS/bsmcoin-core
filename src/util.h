 ...
 */
#ifndef BSMCOIN_UTIL_H
#define BSMCOIN_UTIL_H
...
extern const char * const BSMCOIN_CONF_FILENAME;
extern const char * const BSMCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("bsmcoin-%s", name);
