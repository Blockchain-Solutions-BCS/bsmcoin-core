...
#ifndef BSMCOIN_SCRIPT_STANDARD_H
#define BSMCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a CBsmCoinAddress
 */
...
#endif // BSMCOIN_SCRIPT_STANDARD_H
