...
`qa/pull-tester/test_framework/test_framework.py:BsmCoinTestFramework.main`.
...
if 'ENABLE_WALLET' not in vars():
    ENABLE_WALLET=0
if 'ENABLE_BSMCOIND' not in vars():
    ENABLE_BSMCOIND=0
...
#Set env vars
if "BSMCOIND" not in os.environ:
    os.environ["BSMCOIND"] = BUILDDIR + '/src/bsmcoind' + EXEEXT
if "BSMCOINCLI" not in os.environ:
    os.environ["BSMCOINCLI"] = BUILDDIR + '/src/bsmcoin-cli' + EXEEXT

if EXEEXT == ".exe" and "-win" not in opts:
    # https://github.com/bsmcoin/bsmcoin/commit/d52802551752140cf41f0d9a225a43e84404d3e9
    # https://github.com/bsmcoin/bsmcoin/pull/5677#issuecomment-136646964
    print("Win tests currently disabled by default.  Use -win option to enable")
    sys.exit(0)

if not (ENABLE_WALLET == 1 and ENABLE_UTILS == 1 and ENABLE_BSMCOIND == 1):
    print("No rpc tests to run. Wallet, utils, and bsmcoind must all be enabled")
    sys.exit(0)
...
class RPCCoverage(object):
    ...
    commands per `bsmcoin-cli help` (`rpc_interface.txt`).
