...
class RawTransactionsTest(BsmCoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid bsmcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid bsmcoin address" in e.error['message'])
