...
class WalletTest (BsmCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BSM from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 BSM with subtract fee from amount
        ...
        # Sendmany 10 BSM with subtract fee from amount
        ...
        #     '-zapwallettxes=1',
        #     '-zapwallettxes=2',
        #     # disabled until issue is fixed: https://github.com/bsmcoin/bsmcoin/issues/7463
        #     # '-salvagewallet',
        # ]
