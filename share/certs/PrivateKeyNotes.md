...
unlocked to sign the BsmCoin-Qt.app bundle.
...
allowing somebody to distribute a BsmCoin-Qt.app or bsmcoin-qt-setup.exe with a valid
...
that the bsmcoin-qt.exe file inside the installer had not been tampered with.
