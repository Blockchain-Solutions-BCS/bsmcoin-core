...
### Community Fund - Accumulation of coins, signaled by version bit 7:
  ...
  - Inclusion of an additional output in the Coinstake transaction contributing 0.25BSM to the Community Fund
...
- Accepts URI to sign messages.
    - URIs of the format bsmcoin:http://domain/something/?a=bsmcoin_address&m=some_message will make the wallet to sign “some_message” and return the produced signature as a POST request to the URL specified in the URI.
...
- bsmcoin-tx tool has been updated to use bsmcoin’s own transaction structure
